...
print("La suma total de las temperaturas es:", suma_total)
print("Lacantidad de elementos en lista temperaturas es:", cantidad_temperaturas)
print("El promedio ce las temperaturas es:", promedio)
