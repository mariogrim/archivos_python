...
if (temperatura_1 > temperatura_2 and temperatura_1 < temperatura_3) or (temperatura_1 < temperatura_2 and temperatura_1 > temperatura_3):
    temperatura_intermedia = temperatura_1
elif (temperatura_2 > temperatura_1 and temperatura_2 < temperatura_3) or (temperatura_2 < temperatura_1 and temperatura_2 > temperatura_3):
...
print ("La temperatura intermedia es:", temperatura_intermedia)
